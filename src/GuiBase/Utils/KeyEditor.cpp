...
namespace Ra
{
    namespace Gui
    {
        KeyEditor::KeyEditor() : QWidget(), m_ui(new Ui::KeyEditor)
        {
            ...
            connect(m_ui->okButton,SIGNAL(clicked()),this,SLOT(okClick()));
        ...
        void KeyEditor::Xml()
        {
          //this part construct the shortcut tab
                ...
                //Shortcut n°1
                tempoKeySequence=m_ui->keySequenceEdit->keySequence();
                ...
                QString shortcut = tempoKeySequence.toString();
                std::cout<<shortcut.toStdString()<<std::endl;
                //Shortcut n°2
                tempoKeySequence=m_ui->keySequenceEdit_2->keySequence();
                if(tempoKeySequence.isEmpty())
                {
                    keyTab[1]="Key_V";
                }else{
                ...
                //Shortcut n°3
                tempoKeySequence=m_ui->keySequenceEdit_3->keySequence();
                if(tempoKeySequence.isEmpty())
                {
                    keyTab[2]="Key_E";
                }else{
                ...
                //Shortcut n°4
                tempoKeySequence=m_ui->keySequenceEdit_4->keySequence();
                if(tempoKeySequence.isEmpty())
                {
                    keyTab[3]="Key_T";
                }else{
                ...
                //Shortcut n°5
                tempoKeySequence=m_ui->keySequenceEdit_5->keySequence();
                if(tempoKeySequence.isEmpty())
                {
                    keyTab[4]="Key_C";
                }else{
                ...
                //Shortcut n°6
                tempoKeySequence=m_ui->keySequenceEdit_6->keySequence();
                if(tempoKeySequence.isEmpty())
                {
                    keyTab[5]="Key_R";
                }else{
                ...
                //Shortcut n°7
                tempoKeySequence=m_ui->keySequenceEdit_7->keySequence();
                if(tempoKeySequence.isEmpty())
                {
                    keyTab[6]="Key_Z";
                }else{
